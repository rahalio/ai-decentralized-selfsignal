 ...
 *
 * @returns The core table name (e.g., "selfsignal-core-dev")
 ...
 *
 * @returns The base table name (e.g., "selfsignal-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "selfsignal-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "selfsignal-app-realtime-dev")
