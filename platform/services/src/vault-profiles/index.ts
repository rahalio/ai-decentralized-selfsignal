/**
 * VaultProfiles Services - Application Layer Export
 *
...
/**
 * VaultProfiles Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for vault-profiles domain.
 */
