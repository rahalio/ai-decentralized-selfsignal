/**
 * RightsRequests Services - Application Layer Export
 *
...
/**
 * RightsRequests Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for rights-requests domain.
 */
