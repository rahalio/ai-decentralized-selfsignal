/**
 * CoverageReports Services - Application Layer Export
 *
...
/**
 * CoverageReports Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for coverage-reports domain.
 */
