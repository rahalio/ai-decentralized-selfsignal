/**
 * SignalActivations Services - Application Layer Export
 *
...
/**
 * SignalActivations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for signal-activations domain.
 */
