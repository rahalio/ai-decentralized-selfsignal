/**
 * Purposes Services - Application Layer Export
 *
...
/**
 * Purposes Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for purposes domain.
 */
